...
- Root-workflows får inte ersätta applikationsspecifik validering med generiska kontroller; de fem canonical CI-checkarna ska köra respektive apps verifierade gate.
