...
- dashboard: privat
- documentation: repository-intern under `apps/skvallerbyttan/docs`
...
`Avkroken/Avkroken` är den samlade interna repositoryytan och `apps/portal` driver `avkroken.denied.se`. `apps/skvallerbyttan` äger eventström, Activity och samlad historik.
