...
import { isMixedScopeRepository, isRetiredRepository } from "./repository-policy.mjs";
...
export function normalizePublicRepository(repo) {
  ...
  return {
    ...
    activityPortalUrl: isMixedScopeRepository(name) ? null : projectActivityPath(name),
