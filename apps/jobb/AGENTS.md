...
Delad monorepo-kontext finns i `../../docs/organization/` när den faktiskt gäller flera appar. Jobbs tekniska current-state ägs av `apps/jobb` och dess egen dokumentation.
